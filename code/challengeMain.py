...
def main():
    ...
    dataDirectory = current_directory  # This assumes that the data files are located in the same directory as the script
    submissionDirectory = os.path.join(current_directory, 'results') # Where ready-to-submit result files are found
    modelDirectory = os.path.join(current_directory, 'models')       # Where trained predictive models end up
